...
The dataset utilized is a publicly available data set hosted on Kaggle [@kaggle], originally published in @antonio2019hotel. The original data was cleaned and prepared by @tidytuesday. 
Since the data is a result of an exercise in data cleaning and manipulation, only minimal preprocessing is needed to enable predictive modelling with this data. 
